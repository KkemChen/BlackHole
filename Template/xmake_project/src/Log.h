...
#define log_trace(fmt, ...)                                                                                            \
    kkem::Logger::Get().fmt_printf({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Trace, fmt, ##__VA_ARGS__)
#define LOG_TRACE(fmt, ...)                                                                                            \
    kkem::Logger::Get().log({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Trace, fmt, ##__VA_ARGS__)
#define logtrace(fmt, ...)                                                                                             \
    kkem::Logger::Get().printf({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Trace, fmt, ##__VA_ARGS__)
#define LOGTRACE() kkem::Logger::LogStream({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Trace)

#define log_trace_(logger, fmt, ...)                                                                                   \
    kkem::Logger::Get().fmt_printf_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Trace, fmt,            \
                                    ##__VA_ARGS__)
#define LOG_TRACE_(logger, fmt, ...)                                                                                   \
    kkem::Logger::Get().log_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Trace, fmt, ##__VA_ARGS__)
#define logtrace_(logger, fmt, ...)                                                                                    \
    kkem::Logger::Get().printf_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Trace, fmt, ##__VA_ARGS__)
#define LOGTRACE_(logger) kkem::Logger::LogStream_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Trace)


#define log_debug(fmt, ...)                                                                                            \
    kkem::Logger::Get().fmt_printf({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Debug, fmt, ##__VA_ARGS__)
#define LOG_DEBUG(fmt, ...)                                                                                            \
    kkem::Logger::Get().log({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Debug, fmt, ##__VA_ARGS__)
#define logdebug(fmt, ...)                                                                                             \
    kkem::Logger::Get().printf({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Debug, fmt, ##__VA_ARGS__)
#define LOGDEBUG() kkem::Logger::LogStream({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Debug)

#define log_debug_(logger, fmt, ...)                                                                                   \
    kkem::Logger::Get().fmt_printf_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Debug, fmt,            \
                                    ##__VA_ARGS__)
#define LOG_DEBUG_(logger, fmt, ...)                                                                                   \
    kkem::Logger::Get().log_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Debug, fmt, ##__VA_ARGS__)
#define logdebug_(logger, fmt, ...)                                                                                    \
    kkem::Logger::Get().printf_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Debug, fmt, ##__VA_ARGS__)
#define LOGDEBUG_(logger) kkem::Logger::LogStream_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Debug)


#define log_info(fmt, ...)                                                                                             \
    kkem::Logger::Get().fmt_printf({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Info, fmt, ##__VA_ARGS__)
#define LOG_INFO(fmt, ...)                                                                                             \
    kkem::Logger::Get().log({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Info, fmt, ##__VA_ARGS__)
#define loginfo(fmt, ...)                                                                                              \
    kkem::Logger::Get().printf({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Info, fmt, ##__VA_ARGS__)
#define LOGINFO() kkem::Logger::LogStream({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Info)

#define log_info_(logger, fmt, ...)                                                                                    \
    kkem::Logger::Get().fmt_printf_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Info, fmt,             \
                                    ##__VA_ARGS__)
#define LOG_INFO_(logger, fmt, ...)                                                                                    \
    kkem::Logger::Get().log_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Info, fmt, ##__VA_ARGS__)
#define loginfo_(logger, fmt, ...)                                                                                     \
    kkem::Logger::Get().printf_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Info, fmt, ##__VA_ARGS__)
#define LOGINFO_(logger) kkem::Logger::LogStream_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Info)


#define log_warn(fmt, ...)                                                                                             \
    kkem::Logger::Get().fmt_printf({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Warn, fmt, ##__VA_ARGS__)
#define LOG_WARN(fmt, ...)                                                                                             \
    kkem::Logger::Get().log({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Warn, fmt, ##__VA_ARGS__)
#define logwarn(fmt, ...)                                                                                              \
    kkem::Logger::Get().printf({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Warn, fmt, ##__VA_ARGS__)
#define LOGWARN() kkem::Logger::LogStream({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Warn)

#define log_warn_(logger, fmt, ...)                                                                                    \
    kkem::Logger::Get().fmt_printf_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Warn, fmt,             \
                                    ##__VA_ARGS__)
#define LOG_WARN_(logger, fmt, ...)                                                                                    \
    kkem::Logger::Get().log_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Warn, fmt, ##__VA_ARGS__)
#define logwarn_(logger, fmt, ...)                                                                                     \
    kkem::Logger::Get().printf_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Warn, fmt, ##__VA_ARGS__)
#define LOGWARN_(logger) kkem::Logger::LogStream_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Warn)


#define log_err(fmt, ...)                                                                                              \
    kkem::Logger::Get().fmt_printf({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Error, fmt, ##__VA_ARGS__)
#define LOG_ERR(fmt, ...)                                                                                              \
    kkem::Logger::Get().log({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Error, fmt, ##__VA_ARGS__)
#define logerr(fmt, ...)                                                                                               \
    kkem::Logger::Get().printf({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Error, fmt, ##__VA_ARGS__)
#define LOGERR() kkem::Logger::LogStream({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Error)

#define log_err_(logger, fmt, ...)                                                                                     \
    kkem::Logger::Get().fmt_printf_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Error, fmt,            \
                                    ##__VA_ARGS__)
#define LOG_ERR_(logger, fmt, ...)                                                                                     \
    kkem::Logger::Get().log_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Error, fmt, ##__VA_ARGS__)
#define logerr_(logger, fmt, ...)                                                                                      \
    kkem::Logger::Get().printf_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Error, fmt, ##__VA_ARGS__)
#define LOGERR_(logger) kkem::Logger::LogStream_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Error)


#define log_fatal(fmt, ...)                                                                                            \
    kkem::Logger::Get().fmt_printf({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Fatal, fmt, ##__VA_ARGS__)
#define LOG_FATAL(fmt, ...)                                                                                            \
    kkem::Logger::Get().log({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Fatal, fmt, ##__VA_ARGS__)
#define logfatal(fmt, ...)                                                                                             \
    kkem::Logger::Get().printf({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Fatal, fmt, ##__VA_ARGS__)
#define LOGFATAL() kkem::Logger::LogStream({__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Fatal)

#define log_fatal_(logger, fmt, ...)                                                                                   \
    kkem::Logger::Get().fmt_printf_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Fatal, fmt,            \
                                    ##__VA_ARGS__)
#define LOG_FATAL_(logger, fmt, ...)                                                                                   \
    kkem::Logger::Get().log_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Fatal, fmt, ##__VA_ARGS__)
#define logfatal_(logger, fmt, ...)                                                                                    \
    kkem::Logger::Get().printf_(logger, {__FILE__, __LINE__, __FUNCTION__}, kkem::LogLevel::Fatal, fmt, ##__VA_ARGS__)
